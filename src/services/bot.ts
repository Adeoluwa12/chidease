...
// async function retryOperation(operation: () => Promise<void>, retries = 3, delayMs = 2000) {
...
//         page.waitForSelector('form[name="backupCodeForm"]', { timeout: 120000 }),
//         page.waitForSelector('form[name="authenticatorCodeForm"]', { timeout: 120000 }),
//         page.waitForSelector(".top-applications", { timeout: 120000 }), // Dashboard element
//       ])
...
//     await newBodyFrame.waitForSelector(".av-select", { visible: true, timeout: 120000 })
...
//       // Try alternative approach - look for button with Referrals text
//       console.log("🔍 Trying alternative approach - looking for button with Referrals text...")
...
// // Add a function to start the monitoring process
// export async function startReferralMonitoring(intervalMinutes = 5): Promise<void> {
